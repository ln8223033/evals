...
<%--if($(".goodsid:eq("+i+")").attr("checked")==true)--%>
<%--{--%>
<%--newarrar[j]=$(".goodsid:eq("+i+")");--%>
<%--arrar[j]=$(".goodsid:eq("+i+")").attr("value");--%>
<%--j++;--%>
...
<%--if(newarrar[i].attr("checked")==true)--%>
<%--{--%>
<%--newarrar[i].parent().parent().remove();--%>
<%--}--%>
<%--}--%>
...
<%--document.goodsForm.action="${pageContext.request.contextPath }/goods/insertGoods";--%>
<%--document.goodsForm.submit();--%>
<%--}--%>

<%--function queryGoods(){--%>
<%--document.goodsForm.action="${pageContext.request.contextPath }/goods/queryGoods";--%>
<%--document.goodsForm.submit();--%>
<%--}--%>
<%--</script>--%>
<%--</head>--%>
...
<%--<form name="eval" action="${pageContext.request.contextPath }/groupEval/manage.action" method="post">--%>
<%--<table width="100%" bgcolor="EDF5FF" border="1px">--%>
<%--<tr>--%>
<%--<td>--%>
<%--<a href="${pageContext.request.contextPath }/groupEval/create"><input type="button" value="添加新评测" /></a>--%>
<%--<a href="${pageContext.request.contextPath }/groupEval/create"><input type="button" value="编辑" /></a>--%>
<%--<a href="${pageContext.request.contextPath }/groupEval/create"><input type="button" value="删除" /></a>--%>
<%--<a href="${pageContext.request.contextPath }/groupEval/create"><input type="button" value="分组" /></a>--%>
<%--<a href="${pageContext.request.contextPath }/groupEval/create"><input type="button" value="评分任务" /></a>--%>
<%--<a href="${pageContext.request.contextPath }/groupEval/create"><input type="button" value="批量导出学生作业" /></a>--%>
<%--<a href="${pageContext.request.contextPath }/groupEval/create"><input type="button" value="导出所有成绩" /></a>--%>
<%--</td>--%>
<%--</tr>--%>
<%--<tr>--%>
<%--<td>评测项目</td>--%>
...
<%--<tr>--%>
<%--<td >${groupEval.evalTitle}</td>--%>
<%--<td >${groupEval.startTime}</td>--%>
<%--<td >${groupEval.endTime}</td>--%>
<%--<td >${groupEval.groupTime}</td>--%>
<%--<td >${groupEval.uploadTime}</td>--%>
<%--<td >${groupEval.ownerId}</td>--%>
<%--</tr>--%>
<%--</c:forEach>--%>
<%--</table>--%>
<%--</form>--%>
